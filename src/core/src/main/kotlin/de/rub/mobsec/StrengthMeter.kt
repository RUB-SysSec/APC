...
sealed class StrengthMeter {
    ...
    /**
     * The returned score is normalized to be in the range of 0 to 1.
     *
     * @param pattern to analyse.
     *
     ...
     *
     * This means when the actual quantization has 5 steps, nothing changes,
     * and if it has 3 steps, the values are changed to 1 -> 1, 2 -> 3, and 3 -> 5, resulting in 1,3,5.
     *
     * @param pattern to analyse.
     *
     * @return the quantized score of [pattern].
 ...
 */
data object AndriotisMeter : StrengthMeter() {
 ...
 */
data object SunMeter : StrengthMeter() {
 ...
 */
data object SongMeter : StrengthMeter() {
