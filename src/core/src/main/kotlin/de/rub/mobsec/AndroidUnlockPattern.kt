...
interface AndroidUnlockPattern {
    ...
    /**
     * Returns the index of this pattern's starting [node][Node]. The index is defined by the used
     ...
     *
     * Sun counts all intersections, with no regard to where these intersections happen.
     * We call this the intuitive way of counting intersections.
     * Intersections are independent of a segments' direction.
     * The number of intersections is increased by one if two segments intersect.
     * The maximum number of intersections is 18.
     *
     ...
     *
     * Song does _NOT_ count all intersections,
     * they omit intersections that happen directly at the end of a line segment.
     * Intersections are independent of a segments' direction.
     * The number of intersections is increased by one if two segments intersect.
     * The maximum number of intersections is 15.
     *
     * Some examples with two segments:
     *
     ...
     *
     * The number is increased by one each time a node is revisited.
     * This means that if a node is revisited twice, the number is increased by two in total.
     *
     * Some Examples:
     *
     ...
     *
     * Since we are not exactly sure what this means and the author of the paper did not answer our questions,
     * we assume that it means:
     *
     ...
     *
     * As one can see,
     * the problem here is that the minimal longest palindrome is 1,
     * thus never allowing the highest score of 1.
     */
